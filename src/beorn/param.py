...
def sim_par(): ## used when computing and painting profiles on a grid
    par = {
        "Mh_bin_min" : 1e5,
        "Mh_bin_max" : 1e14,
        "binn" : 12,                # to define the initial halo mass at z_ini = solver.z (change the name to Mh_bin_num).
...
def hmf_par(): 
    ## Parameters related to analytical halo mass function 
    ## (PS formalism is used to compute variance in EPS_MAR, and for subhalo MF in excursion set).
    par = {
