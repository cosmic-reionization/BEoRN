...
def plot_1D_profiles(parameters: Parameters, profiles: RadiationProfiles | RadiationProfilesFStarGrid, mass_index: int, redshifts: list, alphas: list, label: str = None, figsize: tuple = (14, 9), fontsize: int = None, labelsize: int = None, f_st: float | None = None, **gridspec_kw) -> None:
